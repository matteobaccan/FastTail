...
- [x] 2.1 Session menu (save as, load, recent, save as default) with native dialogs and the replace confirmation
- [x] 2.2 Dirty tracking and `*` in the title bar
- [x] 2.3 i18n keys in five languages; i18n test

## 3. Docs

- [x] 3.1 README section on sessions
