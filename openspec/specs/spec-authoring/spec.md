...
## Purpose
How OpenSpec artifacts for FastTail are written: the project context and per-artifact rules in `openspec/config.yaml` that every proposal, spec, design and task list follows.
## Requirements
